...
const SHEET_URL = 'https://script.google.com/macros/s/AKfycbxp9t6-txkFRcGNH4Oo9VfnaX3Tt5nh6QnPv-lDfd4H-82AXkc1uEBrcKOAZqBJQinQ/exec'
...
export default async (req) => {
	try {
		...
		const params = new URLSearchParams({ sheetId: SHEET_ID, action, value: JSON.stringify(value) })
